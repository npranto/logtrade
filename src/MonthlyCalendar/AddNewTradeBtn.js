...
function AddNewTradeBtn(props) {
	const { onClick } = props;
	return (
		<div className="AddTradeBtn fixed bottom-1 right-1 mr-2 mb-2">
			<button
				className="text-white px-4 w-auto h-12 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"
				onClick={onClick}
			>
				<svg
					viewBox="0 0 20 20"

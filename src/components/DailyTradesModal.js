...
const DailyTradesModal = (props = {}) => {
  const { activeDateTrades = [], activeDate } = props;
          ...
          <div class="modal-body">
            ...
            <ul class="trade-list">
              ${renderList(activeDateTrades, (activeDateTrade) => {
                const currentTradeProfit = getTotalProfitFromTrades([{ ...activeDateTrade }]);
                return `
                  <li class="trade-item mb-3 rounded">
                    <div class="trade-block p-2">
                      ...
                      <div class="d-flex justify-content-end mb-1">
                        <button type="button" class="btn btn-sm btn-outline-danger" id="delete-trade-btn">Delete</button>
                        <button type="button" class="btn btn-sm btn-outline-warning mx-2" id="update-trade-btn">Update</button>
                      </div>
                    </div>
                  </li>
                `
